...
; wPlayerSubStatus5 or wEnemySubStatus5 bit flags
	...
	enum SUBSTATUS_TAUNTED
	enum SUBSTATUS_GROUNDED
...
; wPlayerScreens or wEnemyScreens bit flags
	...
	enum SCREENS_TAILWIND
	enum SCREENS_AURORA_VEIL

; wPlayerScreens2 or wEnemyScreens2 bit flags
	enum_start 5, -1
	enum SCREENS_STEALTH_ROCKS
	enum SCREENS_SPIKES_1
	enum SCREENS_SPIKES_2
	enum SCREENS_TOXIC_SPIKES_1
	enum SCREENS_TOXIC_SPIKES_2
	enum SCREENS_STICKY_WEB

; wBattleArenaEffects bit flags
	enum_start 5, -1
	enum ARENA_GRAVITY
	enum ARENA_TRICK_ROOM
	enum ARENA_ELECTRIC_TERRAIN
	enum ARENA_GRASSY_TERRAIN
	enum ARENA_MISTY_TERRAIN
	enum ARENA_PSYCHIC_TERRAIN
