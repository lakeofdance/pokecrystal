...
GalarianArticunoAnimationIdle: INCLUDE "gfx/pokemon/articuno_galar/anim_idle.asm"
MegaVenusaurAnimationIdle: INCLUDE "gfx/pokemon/venusaur_mega/anim_idle.asm"
MegaAmpharosAnimationIdle: INCLUDE "gfx/pokemon/ampharos_mega/anim_idle.asm"
