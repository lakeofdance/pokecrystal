...
.do_it
	...
	bit ARENA_GRASSY_TERRAIN, a
	ret z

	callfar IsOpponentAffectedByTerrain
	ret z

	call RestoreLeftiesHP
	ret z
	ld hl, BattleText_TargetRecoveredWithGrassyTerrain
	jp StdBattleTextbox
