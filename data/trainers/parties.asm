...
;    * for TRAINERTYPE_MOVES:      db level; dw species; db 4 moves
;    * for TRAINERTYPE_ITEM:       db level; dw species; db item
;    * for TRAINERTYPE_ITEM_MOVES: db level; dw species; db item, 4 moves
; - db -1 ; end
...
CooltrainerFGroup:
	...
	db 36
	dw RAPIDASH,   STOMP, FIRE_SPIN, FURY_ATTACK, AGILITY
	db -1 ; end
