...
; entries correspond to ANIM_OBJ_* constants
	...
	battleanimobj RELATIVE_X, $ff, BATTLEANIMFRAMESET_05, BATTLEANIMFUNC_1B, PAL_BATTLE_OB_GRAY, ANIM_GFX_HIT ; ANIM_OBJ_08
	...
	battleanimobj RELATIVE_X | X_FLIP | Y_FLIP, $98, BATTLEANIMFRAMESET_2D, BATTLEANIMFUNC_09, PAL_BATTLE_OB_YELLOW, ANIM_GFX_BEAM ; ANIM_OBJ_BEAM_END
...
; from polished crystal:
	...
	battleanimobj RELATIVE_X | X_FLIP, $90, BATTLEANIMFRAMESET_B9, BATTLEANIMFUNC_02, PAL_BATTLE_OB_GREEN, ANIM_GFX_PLANT ; ANIM_OBJ_BULLET_SEED
	battleanimobj RELATIVE_X | X_FLIP, $78, BATTLEANIMFRAMESET_16, BATTLEANIMFUNC_RAZOR_LEAF, PAL_BATTLE_OB_BLUE, ANIM_GFX_PLANT ; ANIM_OBJ_MAGICAL_LEAF
	...
	battleanimobj RELATIVE_X | X_FLIP, $90, BATTLEANIMFRAMESET_78, BATTLEANIMFUNC_3D, PAL_BATTLE_OB_BLUE, ANIM_GFX_OBJECTS ; ANIM_OBJ_KINGSSHIELD
	battleanimobj RELATIVE_X, $ff, BATTLEANIMFRAMESET_10, BATTLEANIMFUNC_10, PAL_BATTLE_OB_RED, ANIM_GFX_FIRE ; ANIM_OBJ_MAGMA
	battleanimobj RELATIVE_X, $b4, BATTLEANIMFRAMESET_2A, BATTLEANIMFUNC_00, PAL_BATTLE_OB_RED, ANIM_GFX_WATER ; ANIM_OBJ_LAVA_PLUME
	battleanimobj RELATIVE_X, $b4, BATTLEANIMFRAMESET_2A, BATTLEANIMFUNC_00, PAL_BATTLE_OB_YELLOW, ANIM_GFX_WATER ; ANIM_OBJ_SANDS
	battleanimobj RELATIVE_X, $98, BATTLEANIMFRAMESET_10, BATTLEANIMFUNC_34, PAL_BATTLE_OB_BLUE, ANIM_GFX_FIRE ; ANIM_OBJ_BLUE_FLARE1
	battleanimobj RELATIVE_X, $90, BATTLEANIMFRAMESET_0F, BATTLEANIMFUNC_0A, PAL_BATTLE_OB_BLUE, ANIM_GFX_FIRE ; ANIM_OBJ_BLUE_FLARE2
	battleanimobj RELATIVE_X, $88, BATTLEANIMFRAMESET_43, BATTLEANIMFUNC_18, PAL_BATTLE_OB_BLUE, ANIM_GFX_CHARGE ; ANIM_OBJ_GEOMANCY
	battleanimobj RELATIVE_X | X_FLIP, $90, BATTLEANIMFRAMESET_BA, BATTLEANIMFUNC_02, PAL_BATTLE_OB_GREEN, ANIM_GFX_ICE ; ANIM_OBJ_BIG_DIAMOND1
	battleanimobj RELATIVE_X | X_FLIP, $90, BATTLEANIMFRAMESET_BA, BATTLEANIMFUNC_02, PAL_BATTLE_OB_YELLOW, ANIM_GFX_ICE ; ANIM_OBJ_BIG_DIAMOND2
	battleanimobj RELATIVE_X | X_FLIP, $90, BATTLEANIMFRAMESET_B9, BATTLEANIMFUNC_02, PAL_BATTLE_OB_RED, ANIM_GFX_ICE ; ANIM_OBJ_SMALL_DIAMOND
	battleanimobj RELATIVE_X, $88, BATTLEANIMFRAMESET_7F, BATTLEANIMFUNC_45, PAL_BATTLE_OB_GREEN, ANIM_GFX_PLANT ; ANIM_OBJ_SEED_FLARE
	battleanimobj RELATIVE_X | X_FLIP, $ff, BATTLEANIMFRAMESET_56, BATTLEANIMFUNC_LEECH_SEED, PAL_BATTLE_OB_GREEN, ANIM_GFX_PLANT ; ANIM_OBJ_NATURES_MADNESS
	battleanimobj RELATIVE_X | X_FLIP, $56, BATTLEANIMFRAMESET_1A, BATTLEANIMFUNC_3F, PAL_BATTLE_OB_BROWN, ANIM_GFX_ROCKS ; ANIM_OBJ_STEALTH_ROCK
	battleanimobj RELATIVE_X | X_FLIP, $99, BATTLEANIMFRAMESET_54, BATTLEANIMFUNC_1F, PAL_BATTLE_OB_BLUE, ANIM_GFX_ROPE ; ANIM_OBJ_COIL
	battleanimobj RELATIVE_X | X_FLIP, $ff, BATTLEANIMFRAMESET_BB, BATTLEANIMFUNC_METEOR, PAL_BATTLE_OB_RED, ANIM_GFX_EXPLOSION ; ANIM_OBJ_METEOR
	battleanimobj RELATIVE_X, $88, BATTLEANIMFRAMESET_72, BATTLEANIMFUNC_METEOR_BEAM, PAL_BATTLE_OB_BLUE, ANIM_GFX_CHARGE ; ANIM_OBJ_METEOR_BEAM
    battleanimobj RELATIVE_X | X_FLIP, $b0, BATTLEANIMFRAMESET_BC, BATTLEANIMFUNC_33, PAL_BATTLE_OB_GRAY, ANIM_GFX_MISC2 ; ANIM_OBJ_FEATHER
	battleanimobj RELATIVE_X, $ff, BATTLEANIMFRAMESET_9F, BATTLEANIMFUNC_07, PAL_BATTLE_OB_RED, ANIM_GFX_MISC2 ; ANIM_OBJ_APPLE
    battleanimobj RELATIVE_X | X_FLIP | Y_FLIP, $80, BATTLEANIMFRAMESET_27, BATTLEANIMFUNC_0F, PAL_BATTLE_OB_GREEN, ANIM_GFX_WATER ; ANIM_OBJ_APPLE_ACID
	battleanimobj RELATIVE_X | X_FLIP, $78, BATTLEANIMFRAMESET_16, BATTLEANIMFUNC_02, PAL_BATTLE_OB_GREEN, ANIM_GFX_PLANT ; ANIM_OBJ_LEAF_STORM
    battleanimobj ABSOLUTE_X, $ff, BATTLEANIMFRAMESET_78, BATTLEANIMFUNC_00, PAL_BATTLE_OB_GRAY, ANIM_GFX_MISC2 ; ANIM_OBJ_XMARK
	battleanimobj RELATIVE_X, $88, BATTLEANIMFRAMESET_43, BATTLEANIMFUNC_18, PAL_BATTLE_OB_YELLOW, ANIM_GFX_CHARGE ; ANIM_OBJ_CHARGE_BEAM
	battleanimobj RELATIVE_X | Y_FLIP, $76, BATTLEANIMFRAMESET_BD, BATTLEANIMFUNC_00, PAL_BATTLE_OB_GRAY, ANIM_GFX_SHAPES ; ANIM_OBJ_COURT_CHANGE1
	battleanimobj RELATIVE_X | Y_FLIP, $76, BATTLEANIMFRAMESET_BE, BATTLEANIMFUNC_00, PAL_BATTLE_OB_GRAY, ANIM_GFX_SHAPES ; ANIM_OBJ_COURT_CHANGE2
	battleanimobj RELATIVE_X | X_FLIP | PRIORITY, $88, BATTLEANIMFRAMESET_88, BATTLEANIMFUNC_3B, PAL_BATTLE_OB_RED, ANIM_GFX_WIND ; ANIM_OBJ_HEAT_WAVE
	battleanimobj RELATIVE_X, $90, BATTLEANIMFRAMESET_0F, BATTLEANIMFUNC_03, PAL_BATTLE_OB_BLUE, ANIM_GFX_FIRE ; ANIM_OBJ_MYSTICAL_FIRE
    battleanimobj RELATIVE_X, $90, BATTLEANIMFRAMESET_21, BATTLEANIMFUNC_18, PAL_BATTLE_OB_YELLOW, ANIM_GFX_MISC2 ; ANIM_OBJ_BEE
