...
.JohtoStarters: buenamon BUENA_MON,    10, CYNDAQUIL, TOTODILE, CHIKORITA
...
.Pokemon1:      buenamon BUENA_MON,    10, PIKACHU, RATTATA, GEODUDE
.Pokemon2:      buenamon BUENA_MON,    10, HOOTHOOT, SPINARAK, DROWZEE
