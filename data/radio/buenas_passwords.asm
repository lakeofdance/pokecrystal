...
.JohtoStarters: buena BUENA_MON,       10, CYNDAQUIL, TOTODILE, CHIKORITA
...
.Pokemon1:      buena BUENA_MON,       10, PIKACHU, RATTATA, GEODUDE
.Pokemon2:      buena BUENA_MON,       10, HOOTHOOT, SPINARAK, DROWZEE
.JohtoTowns:    db BUENA_STRING,       16, "NEW BARK TOWN@", "CHERRYGROVE CITY@", "AZALEA TOWN@"
.Types:         db BUENA_STRING,        6, "FLYING@", "BUG@", "GRASS@"
.Moves:         buena BUENA_MOVE,      12, TACKLE, GROWL, MUD_SLAP
