...
; entries correspond to move ids (see constants/move_constants.asm)
	...
	dw ScaldDescription
	dw SoakDescription
	dw SteamruptionDescription
	dw WatershuriknDescription
	dw StealthrocksDescription
	dw ToxicSpikesDescription
	dw ClangingScalesDescription
	dw HyperspaceFuryDescription
	...
	dw ScorchinSandDescription
	dw ThousandArrowsDescription
	...
	dw SpectralThiefDescription
	dw SpiritShackleDescription
	dw BlastBurnDescription
	dw BlazeKickDescription
	dw BlueFlareDescription
	dw BurningEnvyDescription
	...
	dw HyperspaceHoleDescription
	dw LusterPurgeDescription
	dw MistBallDescription
	dw PrismaticLaserDescription
...
ScaldDescription:
SteamruptionDescription:
ScorchinSandDescription:
...
HyperspaceHoleDescription:
NoSurrenderDescription:
	db   "An attack that"
	next "never misses.@"
...
SpikesDescription:
StealthrocksDescription:
	db   "Hurts foes when"
	next "they switch out.@"

StickyWebDescription:
	db   "Drops foe's SPEED"
	next "upon switch in.@"
...
EerieImpulseDescription:
	db   "Sharply lowers the"
	next "foe's SPCL.ATTACK.@"

FakeTearsDescription:
	db   "Sharply lowers the"
	next "foe's SPCL.DEFENSE.@"
...
SpiritBreakDescription:
	db   "Breaks the spirit"
	next "to lower SPCL.ATK.@"
...
AppleAcidDescription:
	db   "Acidic apple pulp"
	next "lowers SPCL.DEF.@"

GravAppleDescription:
	db   "Drops an apple to"
	next "lower DEFENSE.@"
...
PetalblizardDescription:
	db   "Stirs up a fierce"
	next "petal blizzard.@"
...
WatershuriknDescription:
	db   "Strikes 2-5 times"
	next "and goes first.@"
...
SuperpowerDescription:
	db   "The user's ATTACK"
	next "and DEFENSE drop.@"

VCreateDescription:
	db   "The user's SPEED"
	next "and DEFENCES drop.@"

FellStingerDescription:
	db   "Sharply raises ATK"
	next "after a knockout.@"
...
GeomancyDescription:
	db   "Charge, then raise"
	next "SPEED and SPCL.@"

AcrobaticsDescription:
	db   "Hits harder if the"
	next "user has no item.@"

FacadeDescription:
	db   "Strikes heavily if"
	next "user is statused.@"
...
PsychicFangsDescription:
	db   "Removes foe's pro-"
	next "tective screens.@"
...
PoweruppunchDescription:
	db   "An punch that ups"
	next "the user's ATTACK.@"

SkyUppercutDescription:
	db   "A punch thrown sky"
	next "-ward with force.@"

StormThrowDescription:
FrostBreathDescription:
WickedBlowDescription:
	db   "Always lands a"
	next "critical hit.@"
...
RoostDescription:
	db   "Recovers HP and"
	next "loses FLYING type.@"

BoomburstDescription:
	db   "A booming shout of"
	next "astonishing force.@"

CourtChangeDescription:
	db   "Swaps effects on"
	next "either side.@"
...
AnchorShotDescription:
	db   "An attack that pre"
	next "-vents switching.@"

ThousandArrowsDescription:
SmackDownDescription:
	db   "Knocks flying foes"
	next "to the ground.@"
...
DrakeEnergyDescription:
	db   "Deals greater dam-"
	next "age at higher HP.@"

CrushGripDescription:
WringOutDescription:
	db   "Reduces in power"
	next "as foe's HP falls.@"
...
BurningEnvyDescription:
	db   "Inflicts a burn on"
	next "boosted foes.@"

GyroBallDescription:
	db   "Has more power vs."
	next "faster foes.@"
...
ToxicThreadDescription:
	db   "Poisons the foe"
	next "and drops SPEED.@"

VenomDrenchDescription:
	db   "Drops ATK and SPD"
	next "of a poisoned foe.@"

FinalGambitDescription:
	db   "Deals the user's HP"
	next "as damage.@"

BrutalSwingDescription:
	db   "The user swings its"
	next "body against foe.@"

SacredSwordDescription:
ChipAwayDescription:
DarkLariatDescription:
...
TailwindDescription:
	db   "Doubles speed for"
	next "4 turns.@"

MementoDescription:
	db   "Drops OFFENSES and"
	next "faints the user.@"

WeatherBallDescription:
	db   "Changes power and"
	next "type in weather.@"

LandsWrathDescription:
PrecipiceBladesDescription:
	db   "The energy of the"
	next "land hits the foe.@"

FeintDescription:
	db   "Breaks through"
	next "foes' protection.@"
